...
void hatprintf(FILE* fp, const char* fmt, ...);
...
/* static FileOffset HatCounter = HeaderSize;         unused */
static FileOffset LastExp = 0;
static bool traceOpen = False;
/* static bool atTraceEnd = True;                     unused */
...
mkModule(char *modname, char *srcfile, bool traced)
{
  ...
  writeString(modname);
  writeString(srcfile);
  HIDE(hatprintf(stderr,"\tmkModule %s (name=%s) -> 0x%x\n",modname,srcfile,fo);)
  return fo;
}
...
mkSrcPos(FileOffset moduleTraceInfo,int begin,int end)
{
  ...
  writeInt(begin);
  writeInt(end);
  HIDE(hatprintf(stderr,"\tmkSrcPos begin=%d end=%d -> 0x%x\n",begin,end,fo);)
  return fo;
}
         ...
         ,FileOffset arg1)
{
  ...
  HIDE(hatprintf(stderr,"\tmkResApp1 parent=0x%x use=0x%x fo=0x%x fun=0x%x args=0x%x -> 0x%x\n",parent,use,fo,fun,arg1,fo);)
  return fo;
}

FileOffset
mkAppN(FileOffset parent,FileOffset use,FileOffset fun
      ,int numArgs, FileOffset* args)
{
  FileOffset fo;
  int i;

  fo = writeTag(ExpApp | (use?HasSrcPos:0)
	       ,2 + ((3+numArgs)*sizeof(FileOffset)) + (use?sizeof(FileOffset):0));
  if(use)
    writeFileOffset(use);
  writeFileOffset(parent);
  ...
  writeFileOffset(fun);
  writeByte(numArgs);
  HIDE(hatprintf(stderr,"\tmkAppN parent=0x%x use=0x%x 0x%x fun=0x%x numArgs=%d -> 0x%x\n",parent,use,Unevaluated,fun,numArgs,fo);)
  for (i = 0; i < numArgs; i++){
    HIDE(hatprintf(stderr,"\t\targ %d\t0x%lx\n",i,args[i]);)
    writeFileOffset(args[i]);
  }
  return fo;
}
      ...
      ,FileOffset arg1)
{
  ...
  writeByte(1);
  writeFileOffset(arg1);
  HIDE(hatprintf(stderr,"\tmkApp1 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,Unevaluated,fun,arg1,fo);)
  return fo;
}
      ...
      ,FileOffset arg1,FileOffset arg2)
{
  ...
  HIDE(hatprintf(stderr,"\tmkApp2 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,Unevaluated,fun,arg1,arg2,fo);)
  return fo;
}
      ...
      ,FileOffset arg1,FileOffset arg2,FileOffset arg3)
{
  ...
  HIDE(hatprintf(stderr,"\tmkApp3 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,Unevaluated,fun,arg1,arg2,arg3,fo);)
  return fo;
}
      ...
      ,FileOffset arg1,FileOffset arg2,FileOffset arg3,FileOffset arg4)
{
  ...
  HIDE(hatprintf(stderr,"\tmkApp4 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,Unevaluated,fun,arg1,arg2,arg3,arg4,fo);)
  return fo;
}
      ...
      ,FileOffset arg5)
{
  ...
  HIDE(hatprintf(stderr,"\tmkApp5 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,Unevaluated,fun,arg1,arg2,arg3,arg4,arg5,fo);)
  return fo;
}
      ...
      ,FileOffset arg5,FileOffset arg6)
{
  ...
  HIDE(hatprintf(stderr,"\tmkApp6 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,Unevaluated,fun,arg1,arg2,arg3,arg4,arg5,arg6,fo);)
  return fo;
}
      ...
      ,FileOffset arg5,FileOffset arg6,FileOffset arg7)
{
  ...
  HIDE(hatprintf(stderr,"\tmkApp7 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,Unevaluated,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,fo);)
  return fo;
}
      ...
      ,FileOffset arg5,FileOffset arg6,FileOffset arg7,FileOffset arg8)
{
  ...
  HIDE(hatprintf(stderr,"\tmkApp8 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,Unevaluated,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,fo);)
  return fo;
}
      ...
      ,FileOffset arg9)
{
  ...
  HIDE(hatprintf(stderr,"\tmkApp9 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,Unevaluated,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,fo);)
  return fo;
}
       ...
       ,FileOffset arg9,FileOffset arg10)
{
  ...
  HIDE(hatprintf(stderr,"\tmkApp10 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,Unevaluated,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,fo);)
  return fo;
}
       ...
       ,FileOffset arg9,FileOffset arg10,FileOffset arg11)
{
  ...
  HIDE(hatprintf(stderr,"\tmkApp11 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,Unevaluated,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,fo);)
  return fo;
}
       ...
       ,FileOffset arg9,FileOffset arg10,FileOffset arg11,FileOffset arg12)
{
  ...
  HIDE(hatprintf(stderr,"\tmkApp12 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,Unevaluated,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,fo);)
  return fo;
}
       ...
       ,FileOffset arg13)
{
  ...
  HIDE(hatprintf(stderr,"\tmkApp13 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,Unevaluated,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,fo);)
  return fo;
}
       ...
       ,FileOffset arg13,FileOffset arg14)
{
  ...
  HIDE(hatprintf(stderr,"\tmkApp14 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,Unevaluated,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,fo);)
  return fo;
}
       ...
       ,FileOffset arg13,FileOffset arg14,FileOffset arg15)
{
  ...
  HIDE(hatprintf(stderr,"\tmkApp15 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,Unevaluated,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,fo);)
  return fo;
}

FileOffset
mkValueAppN(FileOffset parent,FileOffset use,FileOffset fun, int numArgs
      ,FileOffset* args)
{
  FileOffset fo;
  int i;
  ...
  fo = writeTag(ExpValueApp | (use?HasSrcPos:0)
	       ,2 + ((2+numArgs)*sizeof(FileOffset)) + (use?sizeof(FileOffset):0));
  if(use)
    writeFileOffset(use);
  writeFileOffset(parent);
  writeFileOffset(fun);
  writeByte(numArgs);
  HIDE(hatprintf(stderr,"\tmkValueApp1 parent=0x%x use=0x%x fun=0x%x numArgs=%d -> 0x%x\n",parent,use,fun,numArgs,fo);)
  for (i = 0; i < numArgs; i++){
    HIDE(hatprintf(stderr,"\t\targ %d\t0x%x\n", i, args[i]));
    writeFileOffset(args[i]);
  }
  return fo;
}
      ...
      ,FileOffset arg1)
{
  ...
  writeByte(1);
  writeFileOffset(arg1);
  HIDE(hatprintf(stderr,"\tmkValueApp1 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,fun,arg1,fo);)
  return fo;
}
      ...
      ,FileOffset arg1,FileOffset arg2)
{
  ...
  writeFileOffset(arg1);
  writeFileOffset(arg2);
  HIDE(hatprintf(stderr,"\tmkValueApp2 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,fun,arg1,arg2,fo);)
  return fo;
}
      ...
      ,FileOffset arg1,FileOffset arg2,FileOffset arg3)
{
  ...
  writeFileOffset(arg2);
  writeFileOffset(arg3);
  HIDE(hatprintf(stderr,"\tmkValueApp3 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,fun,arg1,arg2,arg3,fo);)
  return fo;
}
      ...
      ,FileOffset arg1,FileOffset arg2,FileOffset arg3,FileOffset arg4)
{
  ...
  writeFileOffset(arg3);
  writeFileOffset(arg4);
  HIDE(hatprintf(stderr,"\tmkValueApp4 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,fun,arg1,arg2,arg3,arg4,fo);)
  return fo;
}
      ...
      ,FileOffset arg5)
{
  ...
  writeFileOffset(arg4);
  writeFileOffset(arg5);
  HIDE(hatprintf(stderr,"\tmkValueApp5 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,fun,arg1,arg2,arg3,arg4,arg5,fo);)
  return fo;
}
      ...
      ,FileOffset arg5,FileOffset arg6)
{
  ...
  writeFileOffset(arg5);
  writeFileOffset(arg6);
  HIDE(hatprintf(stderr,"\tmkValueApp6 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,fun,arg1,arg2,arg3,arg4,arg5,arg6,fo);)
  return fo;
}
      ...
      ,FileOffset arg5,FileOffset arg6,FileOffset arg7)
{
  ...
  writeFileOffset(arg6);
  writeFileOffset(arg7);
  HIDE(hatprintf(stderr,"\tmkValueApp7 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,fo);)
  return fo;
}
      ...
      ,FileOffset arg5,FileOffset arg6,FileOffset arg7,FileOffset arg8)
{
  ...
  writeFileOffset(arg7);
  writeFileOffset(arg8);
  HIDE(hatprintf(stderr,"\tmkValueApp8 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,LastExp);)
  return fo;
}
      ...
      ,FileOffset arg9)
{
  ...
  writeFileOffset(arg8);
  writeFileOffset(arg9);
  HIDE(hatprintf(stderr,"\tmkValueApp9 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,LastExp);)
  return fo;
}
      ...
      ,FileOffset arg9,FileOffset arg10)
{
  ...
  writeFileOffset(arg9);
  writeFileOffset(arg10);
  HIDE(hatprintf(stderr,"\tmkValueApp10 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,LastExp);)
  return fo;
}
      ...
      ,FileOffset arg9,FileOffset arg10,FileOffset arg11)
{
  ...
  writeFileOffset(arg10);
  writeFileOffset(arg11);
  HIDE(hatprintf(stderr,"\tmkValueApp11 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,LastExp);)
  return fo;
}
      ...
      ,FileOffset arg9,FileOffset arg10,FileOffset arg11,FileOffset arg12)
{
  ...
  writeFileOffset(arg11);
  writeFileOffset(arg12);
  HIDE(hatprintf(stderr,"\tmkValueApp12 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,LastExp);)
  return fo;
}
      ...
      ,FileOffset arg13)
{
  ...
  writeFileOffset(arg12);
  writeFileOffset(arg13);
  HIDE(hatprintf(stderr,"\tmkValueApp13 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,LastExp);)
  return fo;
}
      ...
      ,FileOffset arg13,FileOffset arg14)
{
  ...
  writeFileOffset(arg13);
  writeFileOffset(arg14);
  HIDE(hatprintf(stderr,"\tmkValueApp14 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,LastExp);)
  return fo;
}
      ...
      ,FileOffset arg13,FileOffset arg14,FileOffset arg15)
{
  ...
  writeFileOffset(arg14);
  writeFileOffset(arg15);
  HIDE(hatprintf(stderr,"\tmkValueApp15 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x -> 0x%x\n",parent,use,fun,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,LastExp);)
  return fo;
}
...
mkChar(FileOffset parent,FileOffset use,char c)
{
  ...
  writeFileOffset(parent);
  writeByte(c);
  HIDE(hatprintf(stderr,"\tmkChar parent=0x%x use=0x%x %c -> 0x%x\n",parent,use,c,fo);)
  return fo;
}
...
mkInt(FileOffset parent,FileOffset use,int i)
{
  ...
  writeFileOffset(parent);
  writeInt(i);
  HIDE(hatprintf(stderr,"\tmkInt parent=0x%x use=0x%x %d -> 0x%x\n",parent,use,i,fo);)
  return fo;
}
...
mkInteger(FileOffset parent,FileOffset use,char *i)
{
  ...
  writeFileOffset(parent);
  writeString(i);
  HIDE(hatprintf(stderr,"\tmkInteger parent=0x%x use=0x%x %s -> 0x%x\n",parent,use,i,fo);)
  return fo;
}
...
mkRat(FileOffset parent,FileOffset use,int num,int denom)
{
  ...
  writeInt(num);
  writeInt(denom);
  HIDE(hatprintf(stderr,"\tmkRat parent=0x%x use=0x%x %d/%d -> 0x%x\n",parent,use,num,denom,fo);)
  return fo;
}
          ...
          ,char *num,char *denom)
{
  ...
  writeString(num);
  writeString(denom);
  HIDE(hatprintf(stderr,"\tmkRational parent=0x%x use=0x%x %s/%s -> 0x%x\n",parent,use,num,denom,fo);)
  return fo;
}
...
mkFloat(FileOffset parent,FileOffset use,float f)
{
  ...
  writeFileOffset(parent);
  writeFloat(f);
  HIDE(hatprintf(stderr,"\tmkFloat parent=0x%x use=0x%x %f -> 0x%x\n",parent,use,f,fo);)
  return fo;
}
...
mkDouble(FileOffset parent,FileOffset use,double d)
{
  ...
  writeFileOffset(parent);
  writeDouble(d);
  HIDE(hatprintf(stderr,"\tmkDouble parent=0x%x use=0x%x %f -> 0x%x\n",parent,use,d,fo);)
  return fo;
}
...
mkValueUse(FileOffset parent,FileOffset use,FileOffset value)
{
  ...
  HIDE(hatprintf(stderr,"\tmkValueUse parent=0x%x use=0x%x val=0x%x -> 0x%x\n",parent,use,value,fo);)
  return fo;
}
...
mkConstUse(FileOffset parent,FileOffset use,FileOffset con)
{
  ...
  writeFileOffset(parent);
  writeFileOffset(con);
  HIDE(hatprintf(stderr,"\tmkConstUse parent=0x%x use=0x%x con=0x%x -> 0x%x\n",parent,use,con,fo);)
  return fo;
}
...
mkConstDef(FileOffset context,FileOffset var)
{
  ...
  writeFileOffset(unevaluated);
  writeFileOffset(var);
  HIDE(hatprintf(stderr,"\tmkConstDef parent=0x%x var=0x%x -> 0x%x\n",context,var,fo);)
  return fo;
}
...
mkGuard(FileOffset parent,FileOffset use,FileOffset cond)
{
  ...
  HIDE(hatprintf(stderr,"\tmkGuard parent=0x%x use=0x%x 0x%x cond=0x%x -> 0x%x\n",parent,use,unevaluated,cond,fo);)
  return fo;
}
...
mkCase(FileOffset parent,FileOffset use,FileOffset cond)
{
  ...
  writeFileOffset(unevaluated);
  writeFileOffset(cond);
  HIDE(hatprintf(stderr,"\tmkCase parent=0x%x use=0x%x 0x%x cond=0x%x -> 0x%x\n",parent,use,Unevaluated,cond,fo);)
  return fo;
}
...
mkIf(FileOffset parent,FileOffset use,FileOffset cond)
{
  ...
  writeFileOffset(unevaluated);
  writeFileOffset(cond);
  HIDE(hatprintf(stderr,"\tmkIf parent=0x%x use=0x%x 0x%x cond=0x%x -> 0x%x\n",parent,use,Unevaluated,cond,fo);)
  return fo;
}
              ...
              ,FileOffset arg,FileOffset binder1,FileOffset bindee1)
{
  ...
  HIDE(hatprintf(stderr,"\tmkFieldUpdate1 parent=0x%x use=0x%x args=0x%x pairs=[0x%x-0x%x] -> 0x%x\n",parent,use,arg,binder1,bindee1,fo);)
  return fo;
}
              ...
              ,FileOffset binder2,FileOffset bindee2)
{
  ...
  HIDE(hatprintf(stderr,"\tmkFieldUpdate2 parent=0x%x use=0x%x arg=0x%x pairs=[0x%x-0x%x,0x%x-0x%x] -> 0x%x\n",parent,use,arg,binder1,bindee1,binder2,bindee2,fo);)
  return fo;
}
              ...
              ,FileOffset binder3,FileOffset bindee3)
{
  ...
  HIDE(hatprintf(stderr,"\tmkFieldUpdate3 parent=0x%x use=0x%x arg=0x%x pairs=[0x%x-0x%x,0x%x-0x%x,0x%x-0x%x] -> 0x%x\n",parent,use,Unevaluated,arg,binder1,bindee1,binder2,bindee2,binder3,bindee3,fo);)
  return fo;
}
...
mkProjection(FileOffset parent,FileOffset use,FileOffset exp)
{
  ...
  writeFileOffset(parent);
  writeFileOffset(exp);
  HIDE(hatprintf(stderr,"\tmkProjection parent=0x%x use=0x%x exp=0x%x -> 0x%x\n",parent,use,exp,fo);)
  return fo;
}
...
mkHidden(FileOffset parent)
{
  ...
  HIDE(hatprintf(stderr,"\tmkHidden parent=0x%x 0x%x -> 0x%x\n",parent,Unevaluated,fo);)
...
mkForward(FileOffset result)
{
  ...
  HIDE(hatprintf(stderr,"\tmkForward 0x%x -> 0x%x\n",Unevaluated,fo);)
  return fo;
}
...
mkDoStmt(FileOffset stmt)
{
  ...
  HIDE(hatprintf(stderr,"\tmkDoStmt stmt=0x%x -> 0x%x\n",stmt,fo);)
  return fo;
}
	  ...
	  ,bool local)
{
  ...
  writeByte(arity);
  writeString(name);
  HIDE(hatprintf(stderr,"\tmkVariable mod=0x%x pos=%d-%d fix=%d arity=%d name=%s local=%d -> 0x%x\n",module,begin,end,fixity,arity,name,local,fo);)
  return fo;
}
             ...
             ,char *name)
{
  ...
  writeByte(arity);
  writeString(name);
  HIDE(hatprintf(stderr,"\tmkConstructor mod=0x%x pos=%d-%d fix=%d arity=%d name=%s local=%d -> 0x%x\n",module,begin,end,fixity,arity,name,fo);)
  return fo;
}
                    ...
                    ,char *name,FileOffset labels[])
{
  ...
  HIDE(hatprintf(stderr,"\tmkConstructorWFields mod=0x%x pos=%d-%d fix=%d arity=%d name=%s -> 0x%x\n",module,begin,end,fixity,arity,name,fo);)
  return fo;
}
...
mkAbstract(char *description)
{
  ...
  HIDE(hatprintf(stderr,"\tmkAbstract desc=%s -> 0x%x\n",description,fo);)
  return fo;
}
...
mkListCons(FileOffset elem,FileOffset tail)
{
  ...
  HIDE(hatprintf(stderr,"\tmkListCons elem=0x%x tail=0x%x -> 0x%x\n",elem,tail,fo);)
  return fo;
}
...
void resResult(FileOffset node,FileOffset result,FileOffset use)
{
  ...
  upd = ntohl(node);
  offs = 1+sizeof(FileOffset)+(use?sizeof(FileOffset):0);

  HIDE(hatprintf(stderr,"\tresResult node=0x%x result=0x%x use=0x%x upd=0x%x\n",node,result, use, upd+offs);)

  hat_reduce(upd, offs, result);
}
